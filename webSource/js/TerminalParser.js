...
var TerminalParser = function () {
     ...
     * @type {string[]}
     */
    // ["internal", "symbol", "string", "digit", "className", "dollar", "global", "grid", "method", "word"];
    this.TYPES = ["\x1B[38;5;226m", "\x1B[38;5;226m", "\x1B[38;5;76m", "\x1B[38;5;51m", "\x1B[38;5;39m",
     ...
     * @type {RegExp}
     */
    this.SYNTAX_REGULAR_EXPRESSION = /(\/[a-z]+)|([\[\]\{\}\(\)\-\+\*\/_=])|("[^"]*")|([0-9]\.?[0-9]*)|(%?[\w\.]+)|(\${1,3}[\w]+)|(\^[\w]+)|(#{2,3}[\w]+)|(\.{2}[\w]+)|([\w]+)/g;
